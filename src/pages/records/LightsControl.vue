<template>
    <div class="mapboxgl-ctrl mapboxgl-ctrl-group absolute mt-62 right-10 top-0 op-30 w-29 h-38">
        <button :class="`${lights ? 'lightsOn' : 'lightsOff'}`" @click="lights = !lights">
            <span
                className="mapboxgl-ctrl-icon" aria-hidden="true"
...
defineOptions({ name: "LightsControl" })

const lights = defineModel("lights", { type: Boolean, default: false })
</script>
