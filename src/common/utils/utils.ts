import type { RPGeometry } from "@/data/run_countries"
import type { FeatureCollection, LineString } from "geojson"
import { MAIN_COLOR, MUNICIPALITY_CITIES_ARR, NEED_FIX_MAP, RUN_TITLES } from "@/common/constants/const"
import { chinaCities } from "@/data/city"
import { chinaGeojson } from "@/data/run_countries"
...
const geoJsonForMap = (): FeatureCollection<RPGeometry> => ({
    type: "FeatureCollection",
    features: worldGeoJson.features.concat(chinaGeojson.features as any) as any
})
